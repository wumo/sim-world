...
interface gen_resource_variable_ops {
  ...
  fun _readVariableOp(resource: Output, dtype: Int, name: String = "ReadVariableOp") = run {
  ...
  fun _resourceGather(resource: Output, indices: Output, dtype: Int, validate_indices: Boolean = true, name: String = "ResourceGather") = run {
  ...
  fun _varHandleOp(dtype: Int, shape: Shape, container: String = "", shared_name: String = "", name: String = "VarHandleOp") = run {
  ...
  fun _variableShape(input: Output, out_type: Int = DT_INT32, name: String = "VariableShape") = run {
