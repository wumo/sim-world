...
fun _cropAndResizeGradImage(grads: Output, boxes: Output, box_ind: Output, image_size: Output, t: Int, method: String = "bilinear", name: String = "CropAndResizeGradImage") = run {
...
fun _decodePng(contents: Output, channels: Long = 0L, dtype: Int = DT_UINT8, name: String = "DecodePng") = run {
...
fun _extractJpegShape(contents: Output, output_type: Int = DT_INT32, name: String = "ExtractJpegShape") = run {
