...
interface gen_parsing_ops {
  ...
  fun _decodeRaw(bytes: Output, out_type: Int, little_endian: Boolean = true, name: String = "DecodeRaw") = run {
  ...
  fun _parseTensor(serialized: Output, out_type: Int, name: String = "ParseTensor") = run {
  ...
  fun _stringToNumber(string_tensor: Output, out_type: Int = DT_FLOAT, name: String = "StringToNumber") = run {
