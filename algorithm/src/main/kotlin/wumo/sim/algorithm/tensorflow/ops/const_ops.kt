...
fun TF.const(shape: Shape, value: FloatArray, name: String = "Const") = const(TensorBuffer(shape, value), name)
fun TF.const(shape: Shape, value: DoubleArray, name: String = "Const") = const(TensorBuffer(shape, value), name)
fun TF.const(shape: Shape, value: BooleanArray, name: String = "Const") = const(TensorBuffer(shape, ByteArray(value.size) { value[it].toByte() }), name)
fun TF.const(shape: Shape, value: ByteArray, name: String = "Const") = const(TensorBuffer(shape, value), name)
fun TF.const(shape: Shape, value: ShortArray, name: String = "Const") = const(TensorBuffer(shape, value), name)
fun TF.const(shape: Shape, value: IntArray, name: String = "Const") = const(TensorBuffer(shape, value), name)
fun TF.const(shape: Shape, value: LongArray, name: String = "Const") = const(TensorBuffer(shape, value), name)
fun TF.const(shape: Shape, value: Array<String>, name: String = "Const") = const(TensorBuffer(shape, value), name)
