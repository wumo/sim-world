...
fun TF.loadAndRemapMatrix(ckpt_path: Output, old_tensor_name: Output, row_remapping: Output, col_remapping: Output, initializing_values: Output, num_rows: Long, num_cols: Long, max_rows_in_memory: Long = -1L, name: String = "LoadAndRemapMatrix") = run {
