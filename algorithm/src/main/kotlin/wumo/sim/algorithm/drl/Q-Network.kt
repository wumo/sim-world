...
//            arrayOf(Tensor.tensor(FloatArray(16) { if (it == s) 1f else 0f }, TensorShape(1, 16)))),
...
//        outputs.clear()
//        Run(StringTensorPairVector(arrayOf("inputs1"),
//            arrayOf(Tensor.tensor(FloatArray(16) { if (it == s1) 1f else 0f }, TensorShape(1, 16)))),
//            StringVector("Qout"),
//            StringVector(),
//            outputs)
//        val Q1 = FloatArray(4)
...
//            arrayOf(Tensor.tensor(FloatArray(16) { if (it == s) 1f else 0f }, TensorShape(1, 16)),
//                Tensor.tensor(targetQ, TensorShape(1, 4)))),
//            StringVector(),
