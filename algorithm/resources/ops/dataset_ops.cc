...
#include "G:/vs_projects/tensorflow/tensorflow/contrib/cmake/build/tensorflow/cc/ops/dataset_ops.h"
...
FeatureStatsDataset::FeatureStatsDataset(const ::tensorflow::Scope& scope,
                                         ::tensorflow::Input input_dataset,
  ...
  if (!scope.ok()) return;
  ::tensorflow::Node* ret;
  const auto unique_name = scope.GetUniqueNameForOp("FeatureStatsDataset");
  auto builder = ::tensorflow::NodeBuilder(unique_name, "FeatureStatsDataset")
                     .Input(_input_dataset)
                     .Input(_tag)
                     .Attr("output_types", output_types)
                     .Attr("output_shapes", output_shapes)
