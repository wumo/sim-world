...
fun generateFiles(path: String, kotlinPackage: String, opCategory: Map<String, Array<String>>) {
  ...
  generateAllInOneFile(opCategory.keys, path, kotlinPackage, "gen_ops")
}

fun generateAllInOneFile(ops: Set<String>, path: String, kotlinPackage: String, name: String) {
  val packagePath = kotlinPackage.replace('.', '/')
  File("$path/$packagePath/$name.kt").sink {
